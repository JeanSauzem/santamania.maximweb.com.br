...
class Products extends \Application\Entity\Products implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Products' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Products' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\Products' . "\0" . 'active', 'createdAt', 'updatedAt', '' . "\0" . 'Application\\Entity\\Products' . "\0" . 'productCategory', '' . "\0" . 'Application\\Entity\\Products' . "\0" . 'unitsMeasure'];
        }
    ...
    public function setProductCategory(\Application\Entity\ProductCategories $productCategory = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProductCategory', [$productCategory]);
    ...
    public function setUnitsMeasure(\Application\Entity\UnitsMeasure $unitsMeasure = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUnitsMeasure', [$unitsMeasure]);

        return parent::setUnitsMeasure($unitsMeasure);
    }
    ...
    public function getUnitsMeasure()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUnitsMeasure', []);

        return parent::getUnitsMeasure();
    }
