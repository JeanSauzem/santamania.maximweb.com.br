 ...
 */
class Counter extends \Application\Entity\Counter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Counter' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Counter' . "\0" . 'date', 'createdAt', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Counter $proxy) {
