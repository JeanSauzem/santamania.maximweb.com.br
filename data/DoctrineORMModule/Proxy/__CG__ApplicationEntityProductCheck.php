 ...
 */
class ProductCheck extends \Application\Entity\ProductCheck implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\ProductCheck' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\ProductCheck' . "\0" . 'total', '' . "\0" . 'Application\\Entity\\ProductCheck' . "\0" . 'checked', 'createdAt', 'updatedAt', '' . "\0" . 'Application\\Entity\\ProductCheck' . "\0" . 'idCounter', '' . "\0" . 'Application\\Entity\\ProductCheck' . "\0" . 'idProduct'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductCheck $proxy) {
    ...
    public function setIdCounter(\Application\Entity\Counter $idCounter = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdCounter', [$idCounter]);

        return parent::setIdCounter($idCounter);
    }
    ...
    public function getIdCounter()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdCounter', []);

        return parent::getIdCounter();
    }
