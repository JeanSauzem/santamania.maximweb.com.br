 ...
 */
class ProductCategories extends \Application\Entity\ProductCategories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\ProductCategories' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\ProductCategories' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\ProductCategories' . "\0" . 'active', 'createdAt', 'updatedAt'];
        }
