 ...
 */
class UnitsMeasure extends \Application\Entity\UnitsMeasure implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\UnitsMeasure' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\UnitsMeasure' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\UnitsMeasure' . "\0" . 'symbol', 'createdAt', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UnitsMeasure $proxy) {
